...
Route::get('/berita', [\App\Http\Controllers\Customer\ProdukController::class, 'berita'])->name('berita');

Route::get('/cuaca', [\App\Http\Controllers\Customer\ProdukController::class, 'cuaca'])->name('cuaca');
